...
function Home() {
  ...
  return (
    <div>
      <div className="bg-[#141024] overflow-hidden">
        <div className="container flex flex-col md:flex-row md:items-center md:justify-center justify-start gap-15 h-[90vh] md:h-auto">
          <div className="flex flex-col items-center gap-5 md:pl-20 text-center md:items-start md:max-w-[500px] pt-15">
            <h1 data-aos="fade-left" data-aos-duration="1000" className="text-3xl md:text-5xl font-bold md:text-left text-white ">ROBO SCHOOL</h1>
            <p data-aos="fade-left" data-aos-duration="1500" className="max-w-[80%] text-md md:text-left text-gray-400 ">
              {t("home.text")}
            </p>
            <a href="#form" data-aos="fade-left" data-aos-duration="2000" className="hidden md:block bg-red-500 px-6 text-xl font-bold text-white py-2 rounded-md">
              {t("home.link")}
            </a>
          </div>
